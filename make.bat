...
call "D:\amennelet\GameBoy\gbdk-n\bin\gbdk-n-link.bat" main.rel BackgroundTiles.rel SpriteTiles.rel KenbakBackgroundMap.rel KenbakMenuMap.rel kenbakscreen.rel -o Kenbak.ihx
